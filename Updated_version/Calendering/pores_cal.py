...
path_nanon = r'new_CBD_nanoporosity'
with open(path_nanon, 'r') as f:
    lines = f.readlines()
    f.close()

new_nano = float(lines[0])
#print(new_nano)

#CALCULATE NUMBER OF VOXELS OF EACH TYPE

path_new = r'porosity_cal_bulk.out'
path_new2 = r'porosity_cal_all.out'
path_new3 = r'check_cal.txt'
...
overall_pores = ((uqvals[0,1] + new_nano*uqvals[1,1])/totvol)*100
